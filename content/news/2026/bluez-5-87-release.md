...
- **transport: Fix set volume failure with invalid device volume** ([#1944](https://github.com/bluez/bluez/pull/1944))
...
- **audio: Add ability to force CIS transport Links property** ([#2058](https://github.com/bluez/bluez/pull/2058))
- **audio: Add ability to force CIS transport Links property** ([#2064](https://github.com/bluez/bluez/pull/2064))
- **audio: Add ability to force CIS transport Links property** ([#2065](https://github.com/bluez/bluez/pull/2065))
- **media: use custom DBus timeouts only when remote side is waiting** ([#2129](https://github.com/bluez/bluez/pull/2129))
...
- **shared/bap: Fix endpoint configuration** ([#1917](https://github.com/bluez/bluez/pull/1917))
...
- **shared/bap: set QoS state when CIS is lost** ([#2124](https://github.com/bluez/bluez/pull/2124))
...
- **shared/bap: add ASE Control Point error responses** ([#2166](https://github.com/bluez/bluez/pull/2166))
- **shared/bap: add ASE Control Point error responses** ([#2174](https://github.com/bluez/bluez/pull/2174))
...
- **shared/bap: Transition ASE to QoS Configured on CIS loss** ([#2209](https://github.com/bluez/bluez/pull/2209))
...
- **bass: Fix crashing on BT_BASS_MOD_SRC** ([#2035](https://github.com/bluez/bluez/pull/2035))
...
- **bass: Fix possible crash on bass_update_bis_sync** ([#2253](https://github.com/bluez/bluez/pull/2253))
...
- **Fix use-after-free in BAP broadcast cleanup** ([#1890](https://github.com/bluez/bluez/pull/1890))
...
- **Fix unsolicited AVRCP RegisterNotification response** ([#1999](https://github.com/bluez/bluez/pull/1999))
- **Fix unsolicited AVRCP RegisterNotification response** ([#2011](https://github.com/bluez/bluez/pull/2011))
- **BAP broadcast fixes** ([#2051](https://github.com/bluez/bluez/pull/2051))
...
- **sdp: fix overflow in sdp_extract_seqtype()** ([#2092](https://github.com/bluez/bluez/pull/2092))
- **sdp: fix overflow in sdp_extract_seqtype()** ([#2093](https://github.com/bluez/bluez/pull/2093))
- **sdp: fix overflow in sdp_extract_seqtype()** ([#2094](https://github.com/bluez/bluez/pull/2094))
- **mpris-proxy: Fix possible crash** ([#2097](https://github.com/bluez/bluez/pull/2097))
...
- **device: Fix btd_device_connect_services not discovering** ([#2023](https://github.com/bluez/bluez/pull/2023))
...
- **device: fix inverted NULL check in gatt_db clone** ([#2132](https://github.com/bluez/bluez/pull/2132))
...
- **device: Refactor device_discover_services function** ([#2185](https://github.com/bluez/bluez/pull/2185))
- **device: Refactor device_discover_services function** ([#2186](https://github.com/bluez/bluez/pull/2186))
- **adapter: Fix failed bonding attempt after LE link disconnection** ([#2188](https://github.com/bluez/bluez/pull/2188))
...
- **doc/btmon: Add missing documentation** ([#1915](https://github.com/bluez/bluez/pull/1915))
- **doc/btmon: Add missing documentation** ([#1916](https://github.com/bluez/bluez/pull/1916))
- **doc/btmon: Add missing documentation** ([#1918](https://github.com/bluez/bluez/pull/1918))
- **doc/qualification: Updates for TCRL pkg101** ([#1934](https://github.com/bluez/bluez/pull/1934))
...
- **doc/btmon: Add GATT database reconstruction guide** ([#1953](https://github.com/bluez/bluez/pull/1953))
- **doc/btmon: Add GATT database reconstruction guide** ([#1954](https://github.com/bluez/bluez/pull/1954))
- **doc/btmon: Split Advertising and Scanning into btmon-advertising.rst** ([#1959](https://github.com/bluez/bluez/pull/1959))
- **doc/btmon: Split Advertising and Scanning into btmon-advertising.rst** ([#1986](https://github.com/bluez/bluez/pull/1986))
...
- **doc: Add missing btmon-cs doc to btmon.rst** ([#2044](https://github.com/bluez/bluez/pull/2044))
...
- **gatt-client:Implement error handling for DB_OUT_OF_SYNC in GATT caching** ([#1879](https://github.com/bluez/bluez/pull/1879))
...
- **shared/mcp: fix crash on destroy after ATT gone** ([#2020](https://github.com/bluez/bluez/pull/2020))
...
- **obexd/bip: Fix uninitialized memory and malformed XML in GetImage request** ([#1982](https://github.com/bluez/bluez/pull/1982))
...
- **l2test: Attempt to use BT_SNDMTU if output MTU has been set** ([#1919](https://github.com/bluez/bluez/pull/1919))
...
- **Functional/integration testing** ([#1935](https://github.com/bluez/bluez/pull/1935))
...
- **BLE-HID/Nintendo Switch 2 support** ([#1968](https://github.com/bluez/bluez/pull/1968))
- **Functional/integration testing** ([#1979](https://github.com/bluez/bluez/pull/1979))
- **Functional/integration testing** ([#1981](https://github.com/bluez/bluez/pull/1981))
...
- **Functional/integration testing** ([#2016](https://github.com/bluez/bluez/pull/2016))
...
- **Add initial Channel Sounding support** ([#2033](https://github.com/bluez/bluez/pull/2033))
- **Add initial Channel Sounding support -** ([#2039](https://github.com/bluez/bluez/pull/2039))
...
- **Add initial Channel Sounding support for** ([#2053](https://github.com/bluez/bluez/pull/2053))
...
- **Add RAS Packet format and Notification support** ([#2070](https://github.com/bluez/bluez/pull/2070))
- **Add RAS Packet format and Notification support** ([#2072](https://github.com/bluez/bluez/pull/2072))
- **Add RAS Packet format and Notification support** ([#2074](https://github.com/bluez/bluez/pull/2074))
- **Add RAS Packet format and Notification support** ([#2076](https://github.com/bluez/bluez/pull/2076))
- **Add ability to desynchronized transports for PTS tests** ([#2077](https://github.com/bluez/bluez/pull/2077))
- **Add RAS Packet format and Notification support** ([#2079](https://github.com/bluez/bluez/pull/2079))
- **Add ability to desynchronized transports for PTS tests** ([#2080](https://github.com/bluez/bluez/pull/2080))
- **Add RAS Packet format and Notification support** ([#2085](https://github.com/bluez/bluez/pull/2085))
...
- **Add helper for "cleanup" variable attribute** ([#2101](https://github.com/bluez/bluez/pull/2101))
- **Add helper for "cleanup" variable attribute** ([#2102](https://github.com/bluez/bluez/pull/2102))
...
- **profile: Set L2CAP IMTU for external profile listeners** ([#2144](https://github.com/bluez/bluez/pull/2144))
- **test-mesh-crypto: Don't attempt to run test if AF_ALG is not available** ([#2147](https://github.com/bluez/bluez/pull/2147))
- **Add configurable default LE PHY policy** ([#2148](https://github.com/bluez/bluez/pull/2148))
- **advertising: add property with advertisement ID** ([#2149](https://github.com/bluez/bluez/pull/2149))
- **Add configurable default LE PHY policy** ([#2150](https://github.com/bluez/bluez/pull/2150))
- **Add configurable default LE PHY policy** ([#2152](https://github.com/bluez/bluez/pull/2152))
...
- **Initial Channel Sounding Support for** ([#2200](https://github.com/bluez/bluez/pull/2200))
- **Initial Channel Sounding Support for** ([#2202](https://github.com/bluez/bluez/pull/2202))
- **btio: Handle EOPNOTSUPP from accept() to prevent busy loop** ([#2203](https://github.com/bluez/bluez/pull/2203))
...
- **Initial Channel Sounding Support for** ([#2217](https://github.com/bluez/bluez/pull/2217))
...
- **input: Fix checking LE bonding on HIDP** ([#2061](https://github.com/bluez/bluez/pull/2061))
- **input: Fix checking LE bonding on HIDP** ([#2062](https://github.com/bluez/bluez/pull/2062))
- **profiles/audio/bass: Use BASS_Modify_Source when assistant is active** ([#2168](https://github.com/bluez/bluez/pull/2168))
...
- **profiles/midi: Fix zero timestampHigh** ([#2255](https://github.com/bluez/bluez/pull/2255))
...
- **shared/shell: Fix SIGSEGV on invalid input** ([#1965](https://github.com/bluez/bluez/pull/1965))
- **shared/ad: Fix not checking length on ad_replace_name** ([#1966](https://github.com/bluez/bluez/pull/1966))
- **shared/shell: Fix SIGSEGV on invalid input** ([#1970](https://github.com/bluez/bluez/pull/1970))
...
- **shared/util: Add MIN/MAX implementations** ([#1994](https://github.com/bluez/bluez/pull/1994))
- **shared/util: Add MIN/MAX implementations** ([#1996](https://github.com/bluez/bluez/pull/1996))
- **shared/gatt-server: Add bt_gatt_server_set_permissions** ([#2000](https://github.com/bluez/bluez/pull/2000))
- **shared/queue: Add way to iterate over queue contents** ([#2008](https://github.com/bluez/bluez/pull/2008))
- **shared/gatt-server: Add bt_gatt_server_set_permissions** ([#2025](https://github.com/bluez/bluez/pull/2025))
...
- **shared/rap: Add client ranging registration and notification parsing** ([#2141](https://github.com/bluez/bluez/pull/2141))
- **shared/rap: Add client ranging registration and notification parsing** ([#2142](https://github.com/bluez/bluez/pull/2142))
- **shared/rap: Add client ranging registration and notification parsing** ([#2143](https://github.com/bluez/bluez/pull/2143))
...
- **tools/btpclient: Move btpclient to client/btpclient directory** ([#1903](https://github.com/bluez/bluez/pull/1903))
...
- **client: Add public broadcast advertising support** ([#2069](https://github.com/bluez/bluez/pull/2069))
- **client: Add public broadcast advertising support** ([#2081](https://github.com/bluez/bluez/pull/2081))
- **client: Add public broadcast advertising support** ([#2082](https://github.com/bluez/bluez/pull/2082))
...
- **client/btpclient: Fix GAP unpair command** ([#2135](https://github.com/bluez/bluez/pull/2135))
...
PR List: https://github.com/bluez/bluez/pulls?q=is%3Apr+is%3Aclosed+closed%3A2026-02-09T21:27:33Z..2026-07-07T16:30:35Z+PW_SID
